...
namespace WebApp.Decorator.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AppIdentiyDbContext context, IProductRepository productRepository)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock")] Product product)
        {
            ...
            {
                product.UserId = User.Claims.First(c => c.Type == ClaimTypes.NameIdentifier).Value;
